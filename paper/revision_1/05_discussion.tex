...
Fifth, generalization to adjacent subjective tasks remains partial. On EMOTIC~\cite{kosti_context_2019}, the privileged text teacher improves an image-only baseline, but the agreement gate cannot fully operate because EMOTIC lacks rich training-time annotator disagreement. We therefore claim framework-level generalization while reserving the gate's incremental benefit for datasets with native agreement annotations.
}
