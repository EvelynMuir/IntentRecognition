...
\end{subfigure}
\caption{\revised{\textbf{Functionally decoupled ambiguity modeling in FDIL.} (a) Visual intent recognition suffers from semantic ambiguity among overlapping intents and supervisory ambiguity from annotator disagreement. (b) FDIL separates semantic refinement via Semantic Local Reranking and Calibration (SLR-C) from uncertainty-aware semantic supervision via Uncertainty-guided Text Distillation (UTD).}}
\label{fig:teaser}
\end{figure}
