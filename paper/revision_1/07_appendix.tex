...
% \revised{To respect the regular-paper page limit, validation-split results are
% not reported in the main text or appendix; the validation-split difficulty and
% content-subset numbers are instead provided in the response letter.}
