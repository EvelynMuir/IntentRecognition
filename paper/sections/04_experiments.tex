...
\begin{table}[t]
\centering
\caption{Component ablation of SADIR on the Intentonomy test split. All numbers are percentages.}
\label{tab:slrc_ablation}
\begin{tabular}{lccccc}
\hline
Method & Macro & Micro & Samples & Avg. & Hard \\
\hline
w/o UTC & 47.90 & 55.98 & 55.18 & 53.02 & 29.71 \\
w/o Gated & 49.69 & 57.90 & 58.98 & 55.52 & \textbf{31.69} \\
Full Method & \textbf{50.89} & \textbf{59.60} & \textbf{59.85} & \textbf{56.78} & 30.76 \\
\hline
\end{tabular}
\end{table}
