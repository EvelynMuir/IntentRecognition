...
\hline
$\checkmark$ &  &  &  & 49.64 & \textbf{58.64} & 58.29 & 55.52 & 29.14 \\
 & $\checkmark$ &  &  & 49.81 & 56.39 & 57.65 & 54.62 & 29.28 \\
 & $\checkmark$ & $\checkmark$ &  & 49.69 & 54.45 & 55.97 & 53.37 & 28.82 \\
 & $\checkmark$ & $\checkmark$ & $\checkmark$ & \textbf{50.31} & 57.97 & \textbf{59.07} & \textbf{55.78} & \textbf{30.24} \\
\hline
\end{tabular}
\end{table}
...
\begin{tabular}{lcccc}
\hline
Method & Macro & Samples & Avg. & Hard \\
\hline
Baseline & 47.40 & 56.41 & 53.41 & 28.45 \\
UTD (w/o gated) & 49.59 & 58.88 & 55.58 & \textbf{30.44} \\
UTD (with gated) & \textbf{50.31} & \textbf{59.07} & \textbf{55.78} & 30.24 \\
\hline
\end{tabular}
\end{table}
...
\begin{table}[t]
\centering
\caption{Component ablation of SADIR under the final lexical-canonical-scenario prior configuration. All numbers are percentages.}
\label{tab:slrc_ablation}
\begin{tabular}{cccccccc}
\hline
Residual Student & Distillation & Gated & Macro & Micro & Samples & Avg. & Hard \\
\hline
$\checkmark$ &  &  & 47.90 & 55.98 & 55.18 & 53.02 & 29.71 \\
$\checkmark$ & $\checkmark$ &  & 49.69 & 57.90 & 58.98 & 55.52 & \textbf{31.69} \\
$\checkmark$ & $\checkmark$ & $\checkmark$ & \textbf{50.89} & \textbf{59.60} & \textbf{59.85} & \textbf{56.78} & 30.76 \\
\hline
\end{tabular}
\end{table}
...
ResNet101 & Full model & 41.88 & 49.96 & 50.57 & 47.47 & 24.68 \\
\hline
CLIP ViT-L/14 & Baseline & 47.40 & 56.42 & 56.41 & 53.41 & 28.45 \\
CLIP ViT-L/14 & Full model & \textbf{50.89} & \textbf{59.60} & \textbf{59.85} & \textbf{56.78} & \textbf{30.76} \\
\hline
\end{tabular}
\end{table}
