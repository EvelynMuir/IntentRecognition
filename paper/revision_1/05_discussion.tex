...
Fifth, we add a transfer analysis on EMOTIC~\cite{kosti_context_2019}, a related affective understanding dataset. Under a five-seed, five-fold protocol, FDIL improves over the baseline on Micro F1, Samples F1, and mAP, with significant gains on Micro F1 and mAP. Ablations show that the improvement mainly comes from agreement-gated UTD, while SLR-C is more dependent on the compatibility between label semantics and the target label space.}
