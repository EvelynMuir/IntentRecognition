...
\revloc{Sec.~\ref{sec:intro}, Sec.~\ref{sec:related_work}, and Sec.~\ref{sec:decoupling_principle}}
...
& Standard KD & $44.55$ & $62.83$ & $\mathbf{62.75}$ & $\mathbf{44.37}$ & $37.38$ \\
& Gated KD & $\mathbf{44.58}$ & $\mathbf{62.88}$ & $62.72$ & $44.32$ & $\mathbf{37.45}$ \\
\hline
\multirow{3}{*}{$2/3$}
& Baseline & $40.84$ & $54.39$ & $54.84$ & $44.63$ & $34.30$ \\
& Standard KD & $41.04$ & $\mathbf{55.00}$ & $\mathbf{55.63}$ & $44.85$ & $34.44$ \\
& Gated KD & $\mathbf{41.20}$ & $54.92$ & $55.41$ & $\mathbf{45.18}$ & $\mathbf{34.69}$ \\
\hline
\multirow{3}{*}{$1$}
& Baseline & $22.42$ & $36.31$ & $36.60$ & $34.07$ & $\mathbf{18.23}$ \\
& Standard KD & $\mathbf{22.83}$ & $\mathbf{37.28}$ & $\mathbf{37.80}$ & $34.07$ & $18.05$ \\
& Gated KD & $22.15$ & $36.79$ & $37.20$ & $\mathbf{34.34}$ & $17.41$ \\
\hline
\end{tabular}
\end{table}

\revloc{Sec.~\ref{sec:discussion} (Limitations and Future Directions); auxiliary results in Tables~\ref{tab:emotic_pool} and~\ref{tab:emotic_agreement} of this letter}
