...
Tables~\ref{tab:rationale_ablation_val} to \ref{tab:prior_ablation_val} further mirror the ablation findings in the main text. In particular, rationale design, agreement-aware gating, and heterogeneous priors show consistent contributions on the validation split.
...
SADIR (full) & 58.33 & \textbf{62.78} & 63.47 & \textbf{61.53} & \textbf{45.90} \\
\hline
\end{tabular}
\end{table}
...
ResNet101 & SADIR (full) & 47.26 & 53.45 & 54.47 & 51.73 & 35.12 \\
\hline
CLIP ViT-L/14 & Baseline & 55.80 & 59.62 & 60.10 & 58.51 & 40.48 \\
CLIP ViT-L/14 & SADIR (full) & \textbf{58.33} & \textbf{62.78} & \textbf{63.47} & \textbf{61.53} & \textbf{45.90} \\
\hline
\end{tabular}
\end{table}
