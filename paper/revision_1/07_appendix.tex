...
% % The validation trend is consistent with the test set findings: the strong CLIP baseline already establishes a high starting point, UTD-only training brings a clear additional gain, and the full FDIR configuration achieves the strongest overall performance.
...
% FDIR (UTD only) & Ours & 57.86 & 62.16 & 63.88 & 61.30 \\
% FDIR & Ours & \textbf{59.34} & \textbf{63.06} & \textbf{63.51} & \textbf{61.97} \\
% \hline
% \end{tabular}
% \endgroup
% \end{table}